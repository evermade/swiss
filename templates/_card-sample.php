<div class="c-card c-card--shadow" data-animate="animated zoomIn">
    ...
    <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><div class="c-card__image c-card__image--skewed" style="background-image:url(<?php echo \Swiss\feature_image_url('medium-large'); ?>);"></div></a>
