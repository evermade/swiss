 <section class="b-base">
    ...
    <div class="c-youtube-api-player" data-video-id="LO0t2-4tvNU" data-autoplay="1" data-loop="1" data-sound="0" data-cover="1"></div>

    <div class="c-overlay"></div>

    <div class="b-base__container">
        <div class="b-base__row">
            <div class="b-base__content" data-column-size="6">
                <div class="b-base__wrapper b-base__wrapper--padded">
