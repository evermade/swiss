        ...
        <div class="b-base__row">
            <div class="b-base__content">
                <div class="b-base__wrapper">
                    ...
                    <div class="row h-valign-flexbox">

                        <div class="col-xs-12 col-sm-6">
                            <img src="<?php echo \Swiss\default_img('medium-large'); ?>" alt="image">
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div class="h-wysiwyg-html">
                                ...
                                <p>Here we use a helper class <strong>.h-valign-flexbox</strong> which uses flexbox so vertically align center the content. Sorry IE 9.</p>
