...
function scripts_and_styles() {
	...
	//lets register our assets to be then enqueued later if needed
	...
	//now lets enqueue, this way we can load specific assets on specific pages etc
	wp_enqueue_script( 'modernizr' );
	wp_enqueue_script( 'myquery' );

	wp_enqueue_style( 'our_css' );
