...
<div class="hero-block__slide">
	...
	<div class="hero hero--cover">
		...
		<div class="hero__content">
			<?php echo \Swiss\image($hero['slide_image'], 'medium', 'hero__slide__image'); ?>

			<h1><?php echo $hero['slide_title'] ?></h1>

			<?php echo \Swiss\sprint('<h2>%s</h2>', $hero['slide_sub_title']); ?>

			<?php echo \Swiss\sprint('<div>%s</div>', $hero['slide_text']); ?>

			<?php echo \Swiss\sprint('<a href="%s" class="btn hero__slide__btn">%s</a>', [$hero['slide_button_link'], $hero['slide_button_text']
			]); ?>
		</div>
